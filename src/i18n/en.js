...
export default {
  ...
  avatarDialog: {
    ...
    photoLabelReplace: "Reference photo (choose a new one to replace it)",
    removePhoto: "Remove photo",
    photoRemoved: "Photo removed — save to keep it that way.",
    renameHint: (tag) => `Dreams you write from now on need to say “${tag}”. Entries you already saved keep their old wording.`,
