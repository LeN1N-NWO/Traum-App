...
export default {
  ...
  journal: {
    ...
    actEdit: "Bearbeiten",
    actShare: "Teilen",
    remixLede: "Das sind die Worte, aus denen deine Bilder entstanden sind. Ändere sie, " +
               "und die nächste Runde folgt der neuen Fassung.",
    remixLabel: "Der Traum, aus dem deine Bilder gemacht sind",
    remixGo: "Neue Bilder machen",
